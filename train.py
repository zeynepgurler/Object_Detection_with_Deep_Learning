...
from keras.layers import AveragePooling2D, ZeroPadding2D, Convolution2D, Activation, Add
...
class Config:
	...
	def __init__(self):
        ...
        # Anchor box ratios
		self.anchor_box_ratios = [[1, 1], [1./math.sqrt(2), 2./math.sqrt(2)], [2./math.sqrt(2), 1./math.sqrt(2)], [1./math.sqrt(2), 1], [1, 1./math.sqrt(2)]]
...
def get_data():
    ...
    i = 1
    #path = os.path.join(input_path, 'small.json')
    with open('data2.json', 'r') as f:
        ...
        for image in json_data:
            ...
            for k in fil:
                ...
                i += 1
                imgs = os.path.join('imgs2')
                filename = os.path.join(imgs, filen)
            #filename = os.path.join(input_path, 'JPEGImages', filen) 
                print(filename, class_name, x1, x2, y1, y2)
                ...
                # (filename,ni8,class_name,ni7,x1,y1,x2,y2,ni6,ni5,ni4,ni3,ni2) = line_split
...
class RoiPoolingConv(Layer):
    ...
    def call(self, x, mask=None):
        ...
        for roi_idx in range(self.num_rois):
            ...
            # _ roi of the image to pooling size (7x7)
...
def calc_rpn(C, img_data, width, height, resized_width, resized_height, img_length_calc_function):
    ...
    #output_width = resized_width // 4
    #output_height = resized_height // 4
...
train_path =  'drive/My Drive/Colab Notebooks/data.json' # Training data (annotation file)
...
output_weight_path = 'model3/model_frcnn_vgg.hdf5'

record_path = 'model3/record.csv' # Record data (used to save the losses, classification accuracy and mean average precision)

base_weight_path = 'model3/vgg16_weights_tf_dim_ordering_tf_kernels.h5'

config_output_filename = 'model_vgg_config3.pickle'
...
#                 print('Average number of overlapping bounding boxes from RPN = {} for {} previous iterations'.format(mean_overlapping_bboxes, epoch_length))
            ...
            # Convert rpn layer to roi bboxes
            R = rpn_to_roi(P_rpn[0], P_rpn[1], C, K.image_dim_ordering(), use_regr=True, overlap_thresh=0.5, max_boxes=300)
            ...
            if len(neg_samples) > 0:
                ...
                print("does not generate neg")
                neg_samples = []

            if len(pos_samples) > 0:
                pos_samples = pos_samples[0]
            else:
                print("does not generate pos")
                pos_samples = []
