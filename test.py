...
test_path = 'drive/My Drive/Colab Notebooks' # Test data (annotation file)

test_base_path = 'drive/My Drive/Colab Notebooks/test' # Directory to save the test images
